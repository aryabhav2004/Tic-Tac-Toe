...
def splash():
    ...
    info1_label_1=Label(splash_sk,text="initializing....",font="calibri 50 bold",width=100,bg="#FF7C35",fg="black")
    ...
    def main_code():
        ...
        frame1.pack(pady=20)
        #title
        title_label=Label(frame1,text="Tic Tac Toe",font="calibri 80 bold",bg="#0d2137",fg="white",justify=CENTER,bd=10,width=25)
        ...
        button1=Button(left_frame,text=" ",font=("ArialNovaLight",20),height=3,width=6,bg="white",borderwidth=10,command=lambda: b_click(button1))
        button2=Button(left_frame,text=" ",font=("ArialNovaLight",20),height=3,width=6,bg="white",borderwidth=10,command=lambda: b_click(button2))
        button3=Button(left_frame,text=" ",font=("ArialNovaLight",20),height=3,width=6,bg="white",borderwidth=10,command=lambda: b_click(button3))

        button4=Button(left_frame,text=" ",font=("ArialNovaLight",20),height=3,width=6,bg="white",borderwidth=10,command=lambda: b_click(button4))
        button5=Button(left_frame,text=" ",font=("ArialNovaLight",20),height=3,width=6,bg="white",borderwidth=10,command=lambda: b_click(button5))
        button6=Button(left_frame,text=" ",font=("ArialNovaLight",20),height=3,width=6,bg="white",borderwidth=10,command=lambda: b_click(button6))

        button7=Button(left_frame,text=" ",font=("ArialNovaLight",20),height=3,width=6,bg="white",borderwidth=10,command=lambda: b_click(button7))
        button8=Button(left_frame,text=" ",font=("ArialNovaLight",20),height=3,width=6,bg="white",borderwidth=10,command=lambda: b_click(button8))
        button9=Button(left_frame,text=" ",font=("ArialNovaLight",20),height=3,width=6,bg="white",borderwidth=10,command=lambda: b_click(button9))
        ...
        player_x_label=Label(right_frame_1,text="Player X:",font="arial 40 bold",padx=2,pady=2,fg="white",bg="#0d2137")
        ...
        player_o_label=Label(right_frame_1,text="Player O:",font="arial 40 bold",padx=2,pady=2,fg="white",bg="#0d2137")
        ...
        #reset game
        reset_game_button=Button(right_frame_2,text="Reset Game",font="arial 26 bold",bg="white",height=1,width=20,command=reset_game)
        reset_game_button.grid(row=0,column=0,padx=6,pady=10)

                #new game
        new_game_button=Button(right_frame_2,text="New Game",font="arial 26 bold",bg="white",height=1,width=20,command=new_game)
        new_game_button.grid(row=2,column=0,padx=6,pady=10)

        #exit game
        exit_button=Button(right_frame_2,text="Exit",font="arial 26 bold",bg="white",height=1,width=20,command=exit)
