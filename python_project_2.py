...
frame1.pack(pady=20)
        #title
title_label=Label(frame1,text="Welcome To Tic Tac Toe",font="calibri 80 bold underline",bg="#0d2137",fg="white",justify=CENTER,bd=10,width=25)
...
play_button=Button(right_frame,text="Lets Play Tic Tac Toe!!",font="calibri 35 bold",bg="#0d2137",fg="white",relief=RIDGE,bd=10,command=b_pressed,width=20)
play_button.pack(padx=120,pady=10)
about_button=Button(right_frame,text="About",font="calibri 35 bold",bg="#0d2137",fg="white",relief=RIDGE,bd=10,command=about_press,width=20)
about_button.pack(padx=120,pady=10)
exit_button=Button(right_frame,text="Exit",font="calibri 35 bold",bg="#0d2137",fg="white",relief=RIDGE,bd=10,command=exit_window,width=20)
